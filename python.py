...
gp = graphProblem('Arad','Bucharast',graph)
...
node = graphSearch(gp,0)
print(node.path_cost)
#actions = gp.actions('Arad')

#for a in actions:
#    toState=graph.result('Fageras',a)
#    print(a,gp.goalTest(toState,':',gp.pathCost(0,'Arad',a,toState))
#
